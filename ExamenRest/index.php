...
//Index--> Recopilar toda la informacion de la peticion y crear un request

//Resgistra una funcion de autocarga--> La funcion Se utiliza para evitar poner todos los "REQUIRE" de todas las clases
...
//Dependiendo del request, debemos usar un controlador u otro
// route the request to the right place
$controller_name = ucfirst($url_elements[1]) . 'Controller'; //El elemento 1 es el tipo de objeto --> Ejemplo: persona --> PersonaController
if (class_exists($controller_name)) {
    $controller = new $controller_name();
    $action_name = 'manage' . ucfirst(strtolower($verb)) . 'Verb';//Formar el nombre de las funciones que gestionan los verbos
